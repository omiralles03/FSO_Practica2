...
int main(int n_args, const char *ll_args[]) {
    ...
    if ((n_args != 2) && (n_args != 3)) {
        ...
        fprintf(stderr, "         on \'variabilitat\' indica la frequencia de "
                        "canvi de direccio\n");
        fprintf(stderr, "         de l'oponent: de 0 a 3 (0- gens variable, 3- "
                        "molt variable),\n");
        fprintf(stderr, "         i \'retard\' es el numero de mil.lisegons "
                        "que s'espera entre dos\n");
        fprintf(stderr, "         moviments de cada jugador (minim 10, maxim "
                        "1000, 100 per defecte).\n");
        exit(1);
    }
